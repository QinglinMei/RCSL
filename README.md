...
2) The five datasets for demonstration purpose in the directory *Data* were from https://hemberg-lab.github.io/scRNA.seq.datasets/. These datasets are stored in both RDS and txt format.
