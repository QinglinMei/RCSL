...
The input to *RCSL* is a normalized data matrix with columns being cells and rows being genes in log(CPM+1) (or log(RPKM+1), or log(TPM+1), or log(FPKM+1)) format. 
